...
// 에디터 패널 — 스텝별 줄 포즈 편집 + 설명 작성 + 저장.
// 3D 에서 점을 클릭해 선택하고 기즈모로 끌어 옮기면 현재 스텝의 포즈가 바뀐다.
...
export default function EditorPanel() {
  ...
  return (
    <div className="editor-panel">
      ...
      <p className="ed-hint">
        점을 클릭해 선택 → 기즈모(화살표)로 끌어 옮기면 이 스텝의 줄 모양이 바뀝니다. 스텝마다 모양을 잡으면,
        재생 시 그 순서대로 자연스럽게 보간됩니다.
      </p>
